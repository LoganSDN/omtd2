...
function XRuntimeClient(requestURL, activeRequestLimit) {
     ...
     */
    this.getRuntimeInformation = function (request , handler, timeout) {
        return sendRequest("getRuntimeInformation", request, handler, timeout || this.getRuntimeInformation.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.getLicenseInformation = function (request , handler, timeout) {
        return sendRequest("getLicenseInformation", request, handler, timeout || this.getLicenseInformation.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.getDataInformation = function (request , handler, timeout) {
        return sendRequest("getDataInformation", request, handler, timeout || this.getDataInformation.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.getContentUpdateStatus = function (request , handler, timeout) {
        return sendRequest("getContentUpdateStatus", request, handler, timeout || this.getContentUpdateStatus.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.triggerContentUpdate = function (request , handler, timeout) {
        return sendRequest("triggerContentUpdate", request, handler, timeout || this.triggerContentUpdate.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.getContentUpdateTriggerStatus = function (request , handler, timeout) {
        return sendRequest("getContentUpdateTriggerStatus", request, handler, timeout || this.getContentUpdateTriggerStatus.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.resetMetrics = function (request , handler, timeout) {
        return sendRequest("resetMetrics", request, handler, timeout || this.resetMetrics.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.shutdownServer = function (request , handler, timeout) {
        return sendRequest("shutdownServer", request, handler, timeout || this.shutdownServer.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.restartModules = function (request , handler, timeout) {
        return sendRequest("restartModules", request, handler, timeout || this.restartModules.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.stopRequest = function (request , handler, timeout) {
        return sendRequest("stopRequest", request, handler, timeout || this.stopRequest.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.deleteRequest = function (request , handler, timeout) {
        return sendRequest("deleteRequest", request, handler, timeout || this.deleteRequest.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.convert = function (request , handler, timeout) {
        return sendRequest("convert", request, handler, timeout || this.convert.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.createSupportPackage = function (request , handler, timeout) {
        return sendRequest("createSupportPackage", request, handler, timeout || this.createSupportPackage.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.getServerConfiguration = function (request , handler, timeout) {
        return sendRequest("getServerConfiguration", request, handler, timeout || this.getServerConfiguration.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.getConfigurationFile = function (request , handler, timeout) {
        return sendRequest("getConfigurationFile", request, handler, timeout || this.getConfigurationFile.timeout);
    };
