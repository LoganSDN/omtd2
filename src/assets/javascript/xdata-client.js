...
function XDataClient(requestURL, activeRequestLimit) {
     ...
     */
    this.getSegments = function (request , handler, timeout) {
        return sendRequest("getSegments", request, handler, timeout || this.getSegments.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.getTimeZone = function (request , handler, timeout) {
        return sendRequest("getTimeZone", request, handler, timeout || this.getTimeZone.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.createContentSnapshot = function (request , handler, timeout) {
        return sendRequest("createContentSnapshot", request, handler, timeout || this.createContentSnapshot.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.deleteContentSnapshot = function (request , handler, timeout) {
        return sendRequest("deleteContentSnapshot", request, handler, timeout || this.deleteContentSnapshot.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.listContentSnapshots = function (request , handler, timeout) {
        return sendRequest("listContentSnapshots", request, handler, timeout || this.listContentSnapshots.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.startCreateHighPerformanceRoutingNetwork = function (request , handler, timeout) {
        return sendRequest("startCreateHighPerformanceRoutingNetwork", request, handler, timeout || this.startCreateHighPerformanceRoutingNetwork.timeout);
    };
     ...
     */
    this.runCreateHighPerformanceRoutingNetwork = function (request , handler, watchRequest, onUpdate, retryOptions) {
        return runJob(client.startCreateHighPerformanceRoutingNetwork, request, client.fetchHighPerformanceRoutingNetworkResponse, handler, watchRequest, onUpdate, retryOptions);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.deleteHighPerformanceRoutingNetwork = function (request , handler, timeout) {
        return sendRequest("deleteHighPerformanceRoutingNetwork", request, handler, timeout || this.deleteHighPerformanceRoutingNetwork.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.listHighPerformanceRoutingNetworks = function (request , handler, timeout) {
        return sendRequest("listHighPerformanceRoutingNetworks", request, handler, timeout || this.listHighPerformanceRoutingNetworks.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.createFeatureLayer = function (request , handler, timeout) {
        return sendRequest("createFeatureLayer", request, handler, timeout || this.createFeatureLayer.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.startCreateFeatureLayer = function (request , handler, timeout) {
        return sendRequest("startCreateFeatureLayer", request, handler, timeout || this.startCreateFeatureLayer.timeout);
    };
     ...
     * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached.
     */
    this.runCreateFeatureLayer = function (request , handler, watchRequest, onUpdate, retryOptions) {
        return runJob(client.startCreateFeatureLayer, request, client.fetchFeatureLayerResponse, handler, watchRequest, onUpdate, retryOptions);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.deleteFeatureLayer = function (request , handler, timeout) {
        return sendRequest("deleteFeatureLayer", request, handler, timeout || this.deleteFeatureLayer.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.listFeatureLayers = function (request , handler, timeout) {
        return sendRequest("listFeatureLayers", request, handler, timeout || this.listFeatureLayers.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.fetchFeatureLayerResponse = function (id, onResult, timeout) {
        return sendRequest("fetchFeatureLayerResponse", { id: id }, onResult, timeout || client.fetchFeatureLayerResponse.timeout);
    };
