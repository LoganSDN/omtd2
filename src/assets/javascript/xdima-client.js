...
function XDimaClient(requestURL, activeRequestLimit) {
     ...
     */
    this.createDistanceMatrix = function (request , handler, timeout) {
        return sendRequest("createDistanceMatrix", request, handler, timeout || this.createDistanceMatrix.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.startCreateDistanceMatrix = function (request , handler, timeout) {
        return sendRequest("startCreateDistanceMatrix", request, handler, timeout || this.startCreateDistanceMatrix.timeout);
    };
     ...
     */
    this.runCreateDistanceMatrix = function (request , handler, watchRequest, onUpdate, retryOptions) {
        return runJob(client.startCreateDistanceMatrix, request, client.fetchDistanceMatrixResponse, handler, watchRequest, onUpdate, retryOptions);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.listDistanceMatrices = function (request , handler, timeout) {
        return sendRequest("listDistanceMatrices", request, handler, timeout || this.listDistanceMatrices.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.updateDistanceMatrix = function (request , handler, timeout) {
        return sendRequest("updateDistanceMatrix", request, handler, timeout || this.updateDistanceMatrix.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.startUpdateDistanceMatrix = function (request , handler, timeout) {
        return sendRequest("startUpdateDistanceMatrix", request, handler, timeout || this.startUpdateDistanceMatrix.timeout);
    };
     ...
     * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached.
     */
    this.runUpdateDistanceMatrix = function (request , handler, watchRequest, onUpdate, retryOptions) {
        return runJob(client.startUpdateDistanceMatrix, request, client.fetchDistanceMatrixResponse, handler, watchRequest, onUpdate, retryOptions);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.deleteDistanceMatrix = function (request , handler, timeout) {
        return sendRequest("deleteDistanceMatrix", request, handler, timeout || this.deleteDistanceMatrix.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.getDistanceMatrix = function (request , handler, timeout) {
        return sendRequest("getDistanceMatrix", request, handler, timeout || this.getDistanceMatrix.timeout);
    };
