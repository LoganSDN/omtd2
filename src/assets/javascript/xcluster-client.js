...
function XClusterClient(requestURL, activeRequestLimit) {
     ...
     */
    this.planClusters = function (request , handler, timeout) {
        return sendRequest("planClusters", request, handler, timeout || this.planClusters.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.startPlanClusters = function (request , handler, timeout) {
        return sendRequest("startPlanClusters", request, handler, timeout || this.startPlanClusters.timeout);
    };
     ...
     */
    this.runPlanClusters = function (request , handler, watchRequest, onUpdate, retryOptions) {
        return runJob(client.startPlanClusters, request, client.fetchClustersResponse, handler, watchRequest, onUpdate, retryOptions);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.coverLocations = function (request , handler, timeout) {
        return sendRequest("coverLocations", request, handler, timeout || this.coverLocations.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.startCoverLocations = function (request , handler, timeout) {
        return sendRequest("startCoverLocations", request, handler, timeout || this.startCoverLocations.timeout);
    };
     ...
     * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached.
     */
    this.runCoverLocations = function (request , handler, watchRequest, onUpdate, retryOptions) {
        return runJob(client.startCoverLocations, request, client.fetchClustersResponse, handler, watchRequest, onUpdate, retryOptions);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.planVisits = function (request , handler, timeout) {
        return sendRequest("planVisits", request, handler, timeout || this.planVisits.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.startPlanVisits = function (request , handler, timeout) {
        return sendRequest("startPlanVisits", request, handler, timeout || this.startPlanVisits.timeout);
    };
     ...
     * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached.
     */
    this.runPlanVisits = function (request , handler, watchRequest, onUpdate, retryOptions) {
        return runJob(client.startPlanVisits, request, client.fetchVisitsResponse, handler, watchRequest, onUpdate, retryOptions);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.optimizeVisitSequence = function (request , handler, timeout) {
        return sendRequest("optimizeVisitSequence", request, handler, timeout || this.optimizeVisitSequence.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.startOptimizeVisitSequence = function (request , handler, timeout) {
        return sendRequest("startOptimizeVisitSequence", request, handler, timeout || this.startOptimizeVisitSequence.timeout);
    };
     ...
     * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached.
     */
    this.runOptimizeVisitSequence = function (request , handler, watchRequest, onUpdate, retryOptions) {
        return runJob(client.startOptimizeVisitSequence, request, client.fetchVisitSequenceResponse, handler, watchRequest, onUpdate, retryOptions);
    };
