...
function XRouteClient(requestURL, activeRequestLimit) {
     ...
     */
    this.calculateRoute = function (request , handler, timeout) {
        return sendRequest("calculateRoute", request, handler, timeout || this.calculateRoute.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.startCalculateRoute = function (request , handler, timeout) {
        return sendRequest("startCalculateRoute", request, handler, timeout || this.startCalculateRoute.timeout);
    };
     ...
     */
    this.runCalculateRoute = function (request , handler, watchRequest, onUpdate, retryOptions) {
        return runJob(client.startCalculateRoute, request, client.fetchRouteResponse, handler, watchRequest, onUpdate, retryOptions);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.calculateReachableAreas = function (request , handler, timeout) {
        return sendRequest("calculateReachableAreas", request, handler, timeout || this.calculateReachableAreas.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.startCalculateReachableAreas = function (request , handler, timeout) {
        return sendRequest("startCalculateReachableAreas", request, handler, timeout || this.startCalculateReachableAreas.timeout);
    };
     ...
     * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached.
     */
    this.runCalculateReachableAreas = function (request , handler, watchRequest, onUpdate, retryOptions) {
        return runJob(client.startCalculateReachableAreas, request, client.fetchReachableAreasResponse, handler, watchRequest, onUpdate, retryOptions);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.calculateReachableLocations = function (request , handler, timeout) {
        return sendRequest("calculateReachableLocations", request, handler, timeout || this.calculateReachableLocations.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.startCalculateReachableLocations = function (request , handler, timeout) {
        return sendRequest("startCalculateReachableLocations", request, handler, timeout || this.startCalculateReachableLocations.timeout);
    };
     ...
     * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached.
     */
    this.runCalculateReachableLocations = function (request , handler, watchRequest, onUpdate, retryOptions) {
        return runJob(client.startCalculateReachableLocations, request, client.fetchReachableLocationsResponse, handler, watchRequest, onUpdate, retryOptions);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.getProfile = function (request , handler, timeout) {
        return sendRequest("getProfile", request, handler, timeout || this.getProfile.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.fetchReachableAreasResponse = function (id, onResult, timeout) {
        return sendRequest("fetchReachableAreasResponse", { id: id }, onResult, timeout || client.fetchReachableAreasResponse.timeout);
    };
     ...
     * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
     */
    this.fetchReachableLocationsResponse = function (id, onResult, timeout) {
        return sendRequest("fetchReachableLocationsResponse", { id: id }, onResult, timeout || client.fetchReachableLocationsResponse.timeout);
    };
